...
- SpecSync strict validation passes at advisory threshold 0; all four agents report installed; Trust doctor and native verification pass; all 29 tests pass; macOS, Ubuntu, integration-test, DocC, release, and public API boundaries remain unchanged.
